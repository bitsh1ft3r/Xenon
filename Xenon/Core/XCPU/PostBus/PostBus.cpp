...
void Xe::XCPU::POSTBUS::POST(u64 postCode) {
  ...
  if (postCode >= 0x10 && postCode <= 0x1e) {
    ...
    case 0x10:
      ...
      break;
    case 0x11:
      std::cout << "FSB_CONFIG_PHY_CONTROL - Execute FSB function1"
                << std::endl;
      break;
    case 0x12:
    ...
    case 0x19:
      ...
      break;
    case 0x1a:
      std::cout << "RC4_INITIALIZE - Initialize CB RC4 decryption key"
                << std::endl;
      break;
    case 0x1b:
      ...
      break;
    case 0x1c:
      std::cout << "SHA_COMPUTE - Generate hash of CB for verification"
                << std::endl;
      break;
    case 0x1d:
  ...
  /* 1BL PANICS */
    ...
    case 0x91:
      ...
      break;
    case 0x92:
      std::cout << "PANIC - 1BL is executed on wrong CPU thread (panic)"
                << std::endl;
      system("PAUSE");
      break;
    case 0x93:
      std::cout << "PANIC - TOO_MANY_CORES - 1BL is executed on wrong CPU core "
                   "(panic)"
                << std::endl;
      system("PAUSE");
      break;
    case 0x94:
      std::cout << "PANIC - VERIFY_OFFSET - CB offset verification failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0x95:
      std::cout << "PANIC - VERIFY_HEADER - CB header verification failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0x96:
      std::cout << "PANIC - SIG_VERIFY - CB RSA signature verification failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0x97:
    ...
    case 0x98:
      std::cout
          << "PANIC - NEXT_STAGE_SIZE - Size of next stage is out-of-bounds"
          << std::endl;
      system("PAUSE");
      break;
    }
  ...
  /* CB */
    ...
    case 0x20:
      ...
      break;
    case 0x21:
      std::cout << "INIT_SECOTP - Initialize secotp, verify lockdown fuses"
                << std::endl;
      break;
    case 0x22:
    ...
    case 0x33:
      ...
      break;
    case 0x34:
      std::cout << "HMACSHA_COMPUTE_4BL_CD - Create HMAC key for CD decryption"
                << std::endl;
      break;
    case 0x35:
      std::cout
          << "RC4_INITIALIZE_4BL_CD - Initialize CD RC4 key using HMAC key"
          << std::endl;
      break;
    case 0x36:
      ...
      break;
    case 0x37:
      std::cout << "SHA_COMPUTE_4BL_CD - Compute hash of CD for verification"
                << std::endl;
      break;
    case 0x38:
      std::cout << "SIG_VERIFY_4BL_CD - RSA signature check of CD hash"
                << std::endl;
      break;
    case 0x39:
      std::cout << "SHA_VERIFY_4BL_CD - MemCmp cumputed hash with expected one"
                << std::endl;
      break;
    case 0x3a:
      std::cout << "BRANCH - Setup memory encryption and jump to CD"
                << std::endl;
      break;
    case 0x3b:
  ...
  /* CB PANICS */
    ...
    switch (postCode) {
    case 0x9b:
      std::cout << "PANIC - VERIFY_SECOTP_1 - Secopt fuse verification fail"
                << std::endl;
      system("PAUSE");
      break;
    case 0x9c:
      std::cout << "PANIC - VERIFY_SECOTP_2 - Secopt fuse verification fail2"
                << std::endl;
      system("PAUSE");
      break;
    case 0x9d:
      std::cout << "PANIC - VERIFY_SECOTP_3 - Secopt fuse verification console "
                   "type? fail"
                << std::endl;
      system("PAUSE");
      break;
    case 0x9e:
      std::cout << "PANIC - VERIFY_SECOTP_4 - Secopt fuse verification console "
                   "type? fail"
                << std::endl;
      system("PAUSE");
      break;
    case 0x9f:
      std::cout << "PANIC - VERIFY_SECOTP_5 - Secopt fuse verification console "
                   "type? fail"
                << std::endl;
      system("PAUSE");
      break;
    case 0xa0:
      std::cout << "PANIC - VERIFY_SECOTP_6 - CB revocation check failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0xa1:
    ...
    case 0xa8:
      ...
      break;
    case 0xa9:
      std::cout << "PANIC - HWINIT - HArdware Initialization failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0xaa:
  ...
  /* CB_A */
    ...
    switch (postCode) {
    case 0xD0:
      std::cout << "CB_A_ENTRY - CB_A entry point, copy self to "
                   "0x8000.0200.0001.C000 and continue from there."
                << std::endl;
      break;
    case 0xD1:
      std::cout << "READ_FUSES - Copy fuses from SoC for CB_B decryption."
                << std::endl;
      break;
    case 0xD2:
    ...
    case 0xD3:
      std::cout
          << "FETCH_HEADER_CB_B - Copy CB_B header from NAND for verification."
          << std::endl;
      break;
    case 0xD4:
      ...
      break;
    case 0xD5:
      std::cout << "FETCH_CONTENTS_CB_B - Copy CBB into memory at "
                   "0x8000.0200.0001.0000 (old location of CB_A)."
                << std::endl;
      break;
    case 0xD6:
      std::cout << "HMACSHA_COMPUTE_CB_B - Create HMAC key for CD decryption."
                << std::endl;
      break;
    case 0xD7:
      std::cout << "RC4_INITIALIZE_CB_B - Initialize CD RC4 key using HMAC key."
                << std::endl;
      break;
    case 0xD8:
      ...
      break;
    case 0xD9:
      std::cout << "SHA_COMPUTE_CB_B - Compute hash of CD for verification."
                << std::endl;
      break;
    case 0xDa:
      std::cout << "SHA_VERIFY_CB_B - MemCmp computed hash with expected one "
                   "(where rgh2 glitches)."
                << std::endl;
      break;
    case 0xDb:
  ...
  /* CB_A PANICS */
    ...
    switch (postCode) {
    case 0xF0:
      std::cout << "PANIC - VERIFY_OFFSET_CB_B - CB_B offset verification fail."
                << std::endl;
      system("PAUSE");
      break;
    case 0xF1:
      std::cout << "PANIC - VERIFY_HEADER_CB_B - CB_B header verification fail"
                << std::endl;
      system("PAUSE");
      break;
    case 0xF2:
      std::cout
          << "PANIC - SHA_VERIFY_CB_B - CB_B security hash comparison fail."
          << std::endl;
      system("PAUSE");
      break;
    case 0xF3:
      std::cout << "PANIC - ENTRY_SIZE_INVALID_CB_B - CB_B size check fail "
  ...
  /* CD */
    ...
    case 0x41:
      ...
      break;
    case 0x42:
      std::cout << "FETCH_HEADER - Copy CE header from NAND for verification"
                << std::endl;
      break;
    case 0x43:
      ...
      break;
    case 0x44:
      std::cout << "FETCH_CONTENTS - Read CE from NAND into memory"
                << std::endl;
      break;
    case 0x45:
      std::cout << "HMACSHA_COMPUTE - Create HMAC key for CE decryption"
                << std::endl;
      break;
    case 0x46:
      std::cout << "RC4_INITIALIZE - Initialize CE RC4 key using HMAC key"
                << std::endl;
      break;
    case 0x47:
      ...
      break;
    case 0x48:
      std::cout << "SHA_COMPUTE - Compute hash of CE for verification"
                << std::endl;
      break;
    case 0x49:
      std::cout << "SHA_VERIFY - MemCmp computed hash with expected one. (RGH1 "
                   "Glitches here)"
                << std::endl;
      break;
    case 0x4a:
    ...
    case 0x4d:
      ...
      break;
    case 0x4e:
      std::cout << "FETCH_OFFSET_6BL_CF - Load CD (kernel patches) offset"
                << std::endl;
      break;
    case 0x4f:
      ...
      break;
    case 0x50:
      std::cout << "LOAD_UPDATE_1 - Load CF1/CG1 (patch slot 1) if version & "
                   "header check pass"
                << std::endl;
      break;
    case 0x51:
      std::cout << "LOAD_UPDATE_2 - Load CF2/CG2 (patch slot 2) if version & "
                   "header check pass"
                << std::endl;
      break;
    case 0x52:
      ...
      break;
    case 0x53:
      std::cout << "DECRYPT_VERIFY_HV_CERT - Decrypt and verify hypervisor "
                   "certificate"
                << std::endl;
      break;
    }
  ...
  /* CD PANICS */
    ...
    case 0xB1:
      ...
      break;
    case 0xB2:
      std::cout << "PANIC - VERIFY_HEADER - Failed to verify CE header"
                << std::endl;
      system("PAUSE");
      break;
    case 0xB3:
      ...
      break;
    case 0xB4:
      std::cout << "PANIC - LZX_EXPAND - CE LZX decompression failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0xB5:
      std::cout << "PANIC - VERIFY_OFFSET_6BL - CF verification failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0xB6:
      std::cout << "PANIC - DECODE_FUSES - Fuse decryption/check failed"
                << std::endl;
      system("PAUSE");
      break;
    case 0xB7:
  ...
  /* CE/CF PANICS */
    ...
    switch (postCode) {
    case 0xC1:
      std::cout << "PANIC - LZX_EXPAND_1 - 	Panic - LDICreateDecompression"
                << std::endl;
      system("PAUSE");
      break;
    case 0xC2:
      ...
      break;
    case 0xC3:
      std::cout << "PANIC - LZX_EXPAND_3 - Header/Patch Fragment Info"
                << std::endl;
      system("PAUSE");
      break;
    case 0xC4:
      std::cout << "PANIC - LZX_EXPAND_4 - Unexpected LDI Fragment"
                << std::endl;
      system("PAUSE");
      break;
    case 0xC5:
  ...
  /* HYPERVISOR */
    ...
    switch (postCode) {
    case 0x58:
      std::cout << "INIT_HYPERVISOR - Hypervisor Initialization begin"
                << std::endl;
      break;
    case 0x59:
    ...
    case 0x5d:
      ...
      break;
    case 0x5e:
      std::cout << "INIT_SOC_INT_COMPLETE - Initialization complete"
                << std::endl;
      break;
    }
  }
  ...
  /* KERNEL */
    ...
    case 0x61:
      ...
      break;
    case 0x62:
      std::cout << "INIT_PROCESS_OBJECTS - Initialize process objects"
                << std::endl;
      break;
    case 0x63:
      std::cout << "INIT_KERNEL_DEBUGGER - Initialize kernel debugger"
                << std::endl;
      break;
    case 0x64:
      std::cout << "INIT_MEMORY_MANAGER - Initialize memory manager"
                << std::endl;
      break;
    case 0x65:
    ...
    case 0x66:
      ...
      break;
    case 0x67:
      std::cout << "INIT_PHASE1_THREAD - Initialize phase 1 thread"
                << std::endl;
      break;
    case 0x68:
    ...
    case 0x6C:
      ...
      break;
    case 0x6D:
      std::cout << "INIT_KEY_EX_VAULT - Initialize extended keyvault"
                << std::endl;
      break;
    case 0x6E:
    ...
    case 0x71:
      ...
      break;
    case 0x72:
      std::cout << "INIT_BOOT_ANIMATION - Initialize bootanim.xex, XMADecoder, "
                   "XAudioRender"
                << std::endl;
      break;
    case 0x73:
    ...
    SetConsoleTextAttribute(hConsole, 15);
    std::cout << "POST: Unrecognized post code: " << std::hex << postCode
              << std::endl;
  }
}
